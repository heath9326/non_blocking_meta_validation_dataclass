...
class TestDataclassImproved(TestCase):
    ...
    def test_dataclass_formatted_incorrectly__should_raise_exception_field_formatted_incorrectly(self):
        '''
        All fields are formatter correctly (have 'validator' and 'input_field' or (or key of the same name is present in input_data),
    ...
    def test_dataclass_formatted_correctly__should_return_dataclass_instance(self):
        '''
        All fields are formatter correctly (have 'validator' and 'input_field' in metadata (or key of the same name is present in input_data),
        otherwise raise  ExceptionGroup exception
        '''
        @dataclass
